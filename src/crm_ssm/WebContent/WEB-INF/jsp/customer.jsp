...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="${pageContext.request.contextPath }/index.jsp">BOOT客户管理系统 v2.0</a>
		</div>
		<!-- /.navbar-header -->
		...
		<ul class="nav navbar-top-links navbar-right">
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-messages">
					<li><a href="#">
							<div>
								<strong>宋慧乔</strong> <span class="pull-right text-muted">
									<em>昨天</em>
								</span>
							</div>
							<div>晚上记得回家噢~~</div>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="${pageContext.request.contextPath }/customer/list.do" class="active"><i
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/customer/list.do" method="get">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<table class="table table-bordered table-striped">
							<thead>
								<tr>
									<th><input type="checkbox" id="cb1" onclick="chkSelectAll()"/></th>
									<th>ID</th>
									<th>客户名称</th>
									<th>客户来源</th>
									<th>客户所属行业</th>
							...
							<tbody>
								<c:forEach items="${page.rows}" var="row">
									<tr>
										<th><input type="checkbox" name="ids" value="${row.custId}" id="cb2" /></th>
										<th>${row.custId}</th>
										<th>${row.custName}</th>
										<th>${row.custSource}</th>
										<th>${row.custIndustry}</th>
										<th>${row.custLevel}</th>
										<th>${row.custPhone}</th>
										<th>${row.custMobile}</th>
										<th>
						...
						<div style="float: left;margin-top: 16px">
							<button type="button" onclick="deleteAll();" class="btn btn-primary">批量删除</button>
						</div>
	...
	<script type="text/javascript">
		...
		function updateCustomer() {
			...
			$.post("<%=basePath%>customer/update.do",$("#edit_customer_form").serialize(),function(data){
				alert("客户信息更新成功！");
		...
		function deleteAll(){
			...
			$.post("<%=basePath%>customer/deleteAll.do",{"ids":ids},function(data){
				alert("客户批量删除更新成功！");
				window.location.reload();
			});
		}
